...
author: "Bryan Moon"
canonical: "https://devhandbook.io/blog/2026-08-25-self-hosted-ebook-library"
affiliate: true
cta: true
---
...
- **If you read mostly comics and manga** → **Kavita** (if you want the best reader and fast-moving features) or **Komga** (if you want polish, stability, and Tachiyomi support). Both are excellent; it's a taste call.
- **If you want the Audiobookshelf experience for eBooks** → **Bookshelf**. It's young, but it's the most exciting project in the space, and it's the one I'm personally most optimistic about.

For my own homelab, I'm going to do what I did with audiobooks: start with the tool that matches my actual reading, which is mostly prose. That means **Calibre-Web for now**, with **Bookshelf** running alongside it as a watch-and-see. If Bookshelf matures the way Audiobookshelf did, I'll migrate. If it stalls, I've lost nothing.

## The Setup (Docker Compose, Because That's How We Do It)

Since I promised a guide and not just a comparison, here's the quick-start Docker Compose for the two I'd actually recommend for prose readers. Both are one `docker compose up -d` away.
